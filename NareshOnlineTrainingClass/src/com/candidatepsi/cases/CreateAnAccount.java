...
import com.seleniumprogramms.Reusable_Tasks;
...
public class CreateAnAccount extends Reusable_Tasks {
	...
	public void verify_validation_message_for_existing_accountext() throws InterruptedException {
		...
		Thread.sleep(5000);
		click(By.name("Submit"));
		Assert.assertEquals("Email already exists. Please enter another Email ID",getElementText(By.xpath("*//li[text()=\"Email already exists. Please enter another Email ID\"]")));
